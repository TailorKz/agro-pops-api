...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Autoriza o seu Localhost e a Netlify
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "https://agro-painel.netlify.app"));
        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(Arrays.asList("*"));
        configuration.setAllowCredentials(true); // Fundamental para sistemas com Login/Tokens
